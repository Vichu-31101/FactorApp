...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val progress: ProgressBar = findViewById(R.id.Timer)
        ...
        fun reset(){
            ...
            if(scoreVal > sharedPreference.getInt("highscore", 0 ) )
            {
                ...
                editor.commit()
                highscore.text = "HS: " + scoreVal.toString()
                if(!toastdone){
                    toast.show()
                    toastdone = true
                }
        ...
        timer = object:CountDownTimer(gameTime, gameTimeInterval){
